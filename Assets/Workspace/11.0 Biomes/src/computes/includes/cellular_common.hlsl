...
// --- Centre keep-out (screen 1.2's central cutout) --------------------------------
...
/// composition survives the central cutout in the Jingyao Hongqiao screen.
///
...
/// composite is faded. Smoothstepped and floored rather than cut, because the same master also
/// plays on Xinda Plaza, which has no cutout and would show a hard-edged band as a defect.
