...
## Specs / plans
- [[superpowers/specs/2026-07-14-permeability-mounds-design]] — termite-built persistent mounds partition the field into habitats (reuse permeability ch7 + dead habitat gate); `ResetTermites` melts them
