...
- [[sessions/2026-09-08-video-to-channels-firing-playback]] — `TextureChannelSeeder` routes a video/received raster into biome channels (R/G/B/luma swizzle on `SeedChannelKernel`); `NeuronFiringPlayback` + pure `FramePlayhead` play a blob frame range over wall-clock (Shanghai 125000–131000 / 120 s); ten DAC_params config+umwelt sets for the video cut; finding: 11.0 `externalInfluenceTex` was dead
